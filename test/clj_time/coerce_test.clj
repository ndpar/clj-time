...
(deftest test-to-date
  ...
  #_(is (= (Date. 893462400000) (to-date (date-midnight 1998 4 25))))
...
(deftest test-to-sql-date
  ...
  #_(is (= (java.sql.Date. 893462400000) (to-sql-date (date-midnight 1998 4 25))))
...
(deftest test-to-sql-time
  ...
  (is (= (Timestamp. 893462400000) (to-sql-time (date-time 1998 4 25))))
  #_(is (= (Timestamp. 893462400000) (to-sql-time (date-midnight 1998 4 25))))
  (is (= (Timestamp. 893462400000) (to-sql-time (Date. 893462400000))))
  (is (= (Timestamp. 893462400000) (to-sql-time (Timestamp. 893462400000))))
  (is (= (Timestamp. (long 0)) (to-sql-time 0)))
  (is (= (Timestamp. 893462400000) (to-sql-time 893462400000)))
  (is (= (Timestamp. 893462400000) (to-sql-time (Timestamp. 893462400000))))
  (is (= (Timestamp. 893462400000) (to-sql-time "1998-04-25T00:00:00.000Z"))))
...
(deftest test-to-date-time
  ...
  #_(is (= (date-midnight 1998 4 25) (to-date-time (date-time 1998 4 25))))
  #_(is (= (date-time 2000 1 1 1) (plus (to-date-time (date-midnight 2000 1 1)) (hours 1))))
...
(deftest test-to-long
  ...
  #_(is (= 0 (to-long (date-midnight 1970))))
  #_(is (= (to-long (date-time 1993 3 15)) (to-long (date-midnight 1993 3 15))))
...
(deftest test-to-epoch
  ...
  #_(is (= 0 (to-epoch (date-midnight 1970))))
  #_(is (= (to-epoch (date-time 1993 3 15)) (to-epoch (date-midnight 1993 3 15))))
...
(deftest test-to-string
  ...
  #_(is (= "1998-04-25T00:00:00.000Z" (to-string (date-midnight 1998 4 25))))
...
(deftest test-to-timestamp
  ...
  #_(is (= (Timestamp. 893462400000) (to-timestamp (date-midnight 1998 4 25))))
...
(deftest test-to-local-date
  ...
  (is (= (LocalDate/of 1998 4 25) (to-local-date (date-time 1998 4 25))))
  #_(is (= (LocalDate/of 1998 4 25) (to-local-date (date-midnight 1998 4 25))))
  (is (= (LocalDate/of 1998 4 25) (to-local-date (Date. 893462400000))))
  (is (= (LocalDate/of 1998 4 25) (to-local-date (java.sql.Date. 893462400000))))
  (is (= (LocalDate/of 1970 1 1) (to-local-date 0)))
  (is (= (LocalDate/of 1998 4 25) (to-local-date 893462400000)))
  (is (= (LocalDate/of 1998 4 25) (to-local-date (Timestamp. 893462400000))))
  (is (= (LocalDate/of 1998 4 25) (to-local-date "1998-04-25T00:00:00.000Z"))))

(deftest test-to-local-date-time
  (is (nil? (to-local-date-time nil)))
  (is (nil? (to-local-date-time "")))
  (is (nil? (to-local-date-time "x")))
  (is (= (LocalDateTime/of 1998 4 25 10 20) (to-local-date-time (date-time 1998 4 25 10 20))))
  #_(is (= (LocalDateTime/of 1998 4 25 0 0) (to-local-date-time (date-midnight 1998 4 25))))
  (is (= (LocalDateTime/of 1970 1 1 0 0) (to-local-date-time 0)))
  (is (= (LocalDateTime/of 1998 4 25 0 0 55 0) (to-local-date-time 893462455000)))
  (is (= (LocalDateTime/of 1998 4 25 10 20 30 400000000) (to-local-date-time "1998-04-25T10:20:30.400Z"))))
